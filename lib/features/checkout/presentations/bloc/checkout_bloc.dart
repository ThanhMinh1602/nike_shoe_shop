...
enum PaymentMethod { onDelivery, paypal }
...
extension CheckoutBlocExtension on CheckoutBloc {
  ...
  Future<void> _onSelectPaymentMethod(
      OnTapSelectPaymentEvent event, Emitter<CheckoutState> emitter) async {
    emitter(state.copyWith(paymentMethod: event.paymentMethod));
  }
